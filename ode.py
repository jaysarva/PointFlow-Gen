...
class ODEnet(nn.Module):
    ...
    def __init__(self, hidden_dims, input_shape, context_dim, layer_type="concat", nonlinearity="softplus"):
        ...
        base_layer = {
            "ignore": diffeq.IgnoreLinear,
            "squash": diffeq.SquashLinear,
            "scale": diffeq.ScaleLinear,
            "concat": diffeq.ConcatLinear,
            "concat_v2": diffeq.ConcatLinear_v2,
            "concatsquash": diffeq.ConcatSquashLinear,
            "concatscale": diffeq.ConcatScaleLinear,
        }[layer_type]
